...
public abstract class AbstractMetroStation {
    ...
    public void sortByDecreasingRidership() {
        ...
        while (unsorted) {
            ...
            for (int i = 0; i < getHours().length - 1; i++) {
                if (getHours()[i].getRidership() < getHours()[1 + i].getRidership()) {
    ...
    public void sortByDescendingCommentLength() {
        ...
        for (int i = 0; i < getHours().length; i++) {
            Hour hour = getHours()[i];
            int j;

            for (j = i - 1; j >= 0
                    && Integer.compare(getHours()[j].getCommentLength(), hour.getCommentLength()) < 0; j--) {
    ...
    public AbstractMetroStation createMetroStationHours() {
        ...
        System.out.println(addHour(hour) + "\t"
                + addHour(470, "Medium ridership") + "\t"
                + addHour(105, "Low ridership") + "\t"
    ...
    public void testSortigData() {
        ...
        System.out.println("Sort Operating Hours of by decreasing ridership:");
        sortByDecreasingRidership();
        System.out.println(this);
