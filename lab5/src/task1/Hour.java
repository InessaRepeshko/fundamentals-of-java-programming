 ...
 * It implements {@link Serializable} interface.
 */
public class Hour implements Comparable<Hour>, Serializable {
    /** Unique version identifier for serialisation and deserialisation which ensures the uniqueness of the class. */
    @Serial
     ...
     */
    public static void printHourArray(Hour[] hours) {
